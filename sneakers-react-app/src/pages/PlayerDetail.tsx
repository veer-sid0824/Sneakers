    ...
    if (!player) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
                <h2 className="text-3xl font-bold text-gray-800 mb-4">Player Not Found</h2>
                ...
                >
                    <div className="md:flex">
                        ...
                        <div className="p-8 md:p-12 md:w-1/2 flex flex-col justify-center">
                            ...
                            <p className="mt-4 text-xl text-gray-500">{player.position}</p>
                            ...
                            {player.achievements && player.achievements.length > 0 && (
                                <div className="mt-8">
                                    <h3 className="text-lg font-bold text-gray-900 mb-3">Career Achievements</h3>
