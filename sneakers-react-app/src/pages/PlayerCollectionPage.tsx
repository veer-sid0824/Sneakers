            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="relative h-[40vh] md:h-[60vh] overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
                        <div className="max-w-7xl mx-auto">
                            ...
                            >
                                <p className="text-indigo-600 font-black uppercase tracking-[0.3em] text-sm mb-2">
                                    Signature Series
                                </p>
                        ...
                        >
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-lg font-bold text-slate-900">{player.team}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Position</p>
                                    <p className="text-lg font-bold text-slate-900">{player.position}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1">Collection Size</p>
                                    <p className="text-lg font-bold text-slate-900">{player.shoes.length} Masterpieces</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-8 pb-12">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-white rounded-3xl p-6 shadow-xl shadow-slate-100 border border-slate-50 flex flex-col md:flex-row gap-6 items-center justify-between"
                    >
                        {/* Search */}
                        <div className="relative w-full md:w-96">
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-4 bg-slate-50 border-transparent rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all font-bold text-slate-900"
                            />
                        ...
                        <div className="flex flex-wrap items-center gap-4 w-full md:w-auto">
                            <select
                                ...
                                className="bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold text-slate-900 focus:ring-2 focus:ring-indigo-500"
                            >
                        ...
                        {filteredAndSortedShoes.length > 0 ? (
                            ...
                            >
                                <div className="max-w-xs mx-auto">
                                    ...
                                    <h3 className="text-xl font-bold text-slate-900 mb-2">No shoes found</h3>
