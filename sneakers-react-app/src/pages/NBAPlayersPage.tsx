            ...
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-12 md:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-500">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 md:mb-24">
                        ...
                        >
                            Shop by <span className="text-indigo-600 dark:text-indigo-500">NBA Player</span>
                        </motion.h1>
                        <motion.p
                        ...
                        >
                            Step into the legacy of basketball's greatest. Browse signature silhouettes designed for the elite.
                        </motion.p>
                    </div>
                                ...
                                {PLAYERS.map((player) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative w-full aspect-square overflow-hidden bg-slate-100 dark:bg-slate-800">
                                            ...
                                            <div className="absolute bottom-6 left-8 z-20 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                                ...
                                                <h2 className="text-3xl font-black text-white tracking-tighter">
                                                    ...
                                                    <span className="text-indigo-200">{player.name.split(' ').slice(1).join(' ')}</span>
                                                </h2>
                                            </div>
                                        </div>
                                        ...
                                        <div className="p-8 pb-10">
                                            ...
                                            <Link
                                                to={`/nba/${player.id}`}
                                                className="flex items-center justify-center w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-[1.25rem] py-5 px-6 font-black text-xs tracking-[0.2em] hover:bg-indigo-600 dark:hover:bg-indigo-500 dark:hover:text-white hover:shadow-2xl hover:shadow-indigo-200 dark:hover:shadow-indigo-500/20 transition-all duration-300 active:scale-95 group/btn outline-none focus:ring-4 focus:ring-indigo-500/30"
                                            >
                                                ENTER COLLECTION
                                                <svg
